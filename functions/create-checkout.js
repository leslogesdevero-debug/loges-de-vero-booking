// ===========================================================================
// Fonction Cloudflare Pages : calcule le prix, revérifie la disponibilité,
// puis crée une session de paiement Stripe. La clé secrète Stripe reste ici,
// jamais dans le site public.
// Équivalent Cloudflare de netlify/functions/create-checkout.js
// ===========================================================================
...
const TARIFS_URL = 'https://VOTRE-PROJET.pages.dev/tarifs.json';
const ICS_URLS = {
